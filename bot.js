...
const bot = new TelegramBot('7398508893:AAFqoZK_n0FNZ5I9_5L4BpyDSh3YvatZ3B8', { polling: true });
...
bot.onText(/\/owner/, (msg) => {
    const chatId = msg.chat.id;
    const response = "bow before the almighty ꧁༺ӄɨռɢ ʝօɦǟռ༻꧂🚼.";
...
bot.onText(/\/start/, (msg) => {
    const chatId = msg.chat.id;
    bot.sendMessage(chatId, "Hi this is Johan group manager bot! Use /help for available commands.");
});
...
`;
    ...
    const imageUrl = 'https://raw.githubusercontent.com/DeeCeeXxx/my-media/main/Atomic.jpg';
